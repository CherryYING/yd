...
*/
	...
	WxPayConf::$NOTIFY_URL='http://'.$_SERVER['HTTP_HOST'].'/wxpay/agent_notify_url.php';
...
//	}
	...
	$unifiedOrder->setParameter("body",'易道云商代理');//商品描述
	//自定义订单号，此处仅作举例
	...
	$unifiedOrder->setParameter("notify_url",'http://'.$_SERVER['HTTP_HOST'].'/wxpay/agent_notify_url.php');//通知地址 
		...
		WeixinJSBridge.invoke(
			...
			function(res){
				...
				if(res.err_msg=="get_brand_wcpay_request:ok") {
					...
					var success_url="http://"+domain+"/index.php?g=Weixin&m=Ucenter&a=index";
					location.href=success_url;		 
				}else{
					//alert(res.err_code+res.err_desc+res.err_msg);
					var fail_url="http://"+domain+"/index.php?g=Weixin&m=Agent&a=upgrade";
