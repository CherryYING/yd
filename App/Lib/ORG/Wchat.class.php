...
class Wchat
{
	...
	*/
	...
	/**
	 * 
	 * 用户消息转发到客服好, 此函数支持链式操作
	 * Example: $this->transmitService('msg tips')->reply();
	 */
    public function transmitService($KfAccount='1003@wxshequren')
    {
		$msg = array(
			'ToUserName' => $this->getRevFrom(),
			'FromUserName'=>$this->getRevTo(),
			...
			'CreateTime'=>time(),
			'TransInfo'=>array('KfAccount'=>$KfAccount)		//客服号
		);
       $this->Message($msg);
	   return $this;
    }
