...
class WxRedPack{
	...
	*/
	...
	{		
		...
		curl_setopt($ch,CURLOPT_SSLCERT,getcwd()."/wxpay/cert/apiclient_cert.pem");	
		curl_setopt($ch,CURLOPT_SSLKEY,getcwd()."/wxpay/cert/apiclient_key.pem");	
        curl_setopt($ch,CURLOPT_CAINFO,getcwd()."/wxpay/cert/rootca.pem");	
